...
typedef enum{
	Async_Timer_Clk_Disabled = 0,
	Async_Timer_Clk_PS1,
	Async_Timer_Clk_PS8,
	Async_Timer_Clk_PS32,
	Async_Timer_Clk_PS64,
	Async_Timer_Clk_PS128,
	Async_Timer_Clk_PS256,
	Async_Timer_Clk_PS1024
}Async_Timer_Clock_Source_t;
...
typedef struct{
	uint8_t OCRA;
	uint8_t OCRB;
	Async_Timer_Clock_Source_t clock;
	Timer_8b_Mode_t mode;
	Timer_Output_Compare_Mode_t OCA;
	Timer_Output_Compare_Mode_t OCB;
	Timer_Interrupt_Mask_t interrupt_mask;
