...
#define KP_BY_DEFAULT							0.01
#define KI_BY_DEFAULT							1.0
#define KD_BY_DEFAULT							0.0

#define I_COMPONENT_POSITIVE_LIMIT				10.0
#define I_COMPONENT_NEGATIVE_LIMIT				-1000.0	
