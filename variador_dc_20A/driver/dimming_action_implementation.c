...
void External_Interrupt_Initialize(void){
	...
	/* Configure ZCD_SYNC as digital input */
	DDR_ZCD_SYNC &= ~(1 << ZCD_SYNC);
	/* Generate an external interrupt when a RISING EDGE is detected at INT0 */
	EICRA |= (1 << ISC00) | (1 << ISC01);
	/* Enable the interrupt generated by INT0 */
	EIMSK |= (1 << INT0);
}
...
void Trigger_Implementation_Initialize(void){
	...
	DDR_TRIGGER_PULSE |= (1 << TRIGGER_PULSE);
	PORT_TRIGGER_PULSE &= ~(1 << TRIGGER_PULSE);
